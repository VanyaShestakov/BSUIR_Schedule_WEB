    ...
    <ul id="navbar">
      <li>
        <form action="BSUIRSchedule" method="GET" >
          <input class="page_button" style="width: auto; outline: none;" type="submit" value="Расписание группы"/>
        </form>
      </li>
      <li>
        <form action="teachers" method="GET">
          <input id="active" class="page_button" style="width: auto; outline: none; " type="submit" value="Преподаватели"/>
        </form>
      </li>
